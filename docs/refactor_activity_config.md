...
templates:
  # ── 传说中的魔法少女 · 复刻地图活动 ──
  magic-girl-rerun:
    route_type: rerun_ui             # 路由类型，决定 InnerRouteStart.next
    rerun_column: right              # 复刻地图列位：main / left / right
    activity_section:
      expected: ["限时活动"]
      roi: [480, 90, 150, 80]
    activity_name:
...
activities:
  - name: "传说中的魔法少女 - 招募-02"
    description: "限时活动 → 传说中的魔法少女 → 招募-02"
    template: magic-girl-rerun
    stage_titles: ["招募-02", "招募02"]
    stage_subtitles: []

  - name: "传说中的魔法少女 - 充能-02"
    description: "限时活动 → 传说中的魔法少女 → 充能-02"
    template: magic-girl-rerun
    stage_titles: ["充能-02", "充能02"]
    stage_subtitles: []
```
...
```yaml
  - name: "传说中的魔法少女 - 主线-03"
    description: "限时活动 → 传说中的魔法少女 → 主线-03"
    template: magic-girl-rerun
    stage_titles: ["主线-03", "主线03"]
    stage_subtitles: []
```
